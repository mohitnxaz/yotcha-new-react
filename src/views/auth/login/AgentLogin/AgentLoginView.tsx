...
import { useAgentLogin } from "../../../../hooks/auth/useAuth";
...
const validationSchema = yup.object({
  ...
  ceaNumber: yup.string().required("CEA Number is required"),
});

const AgentLoginView = () => {
  const { mutate } = useAgentLogin();
