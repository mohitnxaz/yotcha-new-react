...
import { useUserLoginOtp } from "../../../../hooks/auth/useLogin";
          ...
          <div className="bg-[white] w-full max-w-[585px] mx-auto rounded-[4px] pt-[60px] pb-[50px] px-4 md:px-[60px] flex flex-col justify-between">
            <div className="flex flex-col items-center">
              ...
              <p className="font-[400] text-[14px] text-[#545454] pt-[10px] pb-[42px] select-none text-center">
                ...
                the code here to continue logging in.
              </p>
