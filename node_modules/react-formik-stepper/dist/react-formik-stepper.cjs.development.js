...
var FormikStepper = function FormikStepper(props) {
  ...
  var schema = yup.object().shape(((_child$props = child.props) == null ? void 0 : _child$props.validation) || {});
  var transitions = {
  ...
  return React__default.createElement(formik.Formik, Object.assign({}, rest, {
    ...
    }, isReactComponent(child) ? React__default.cloneElement(filteredChild, {
      currentStep: step + 1,
